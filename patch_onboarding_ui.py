...
# Replace hardcoded roadmap steps with stringResource
old_steps = """                    if (relatesToLoans == true) {
                        stepsList.add(0, Triple("Debt Payoff Strategy", "We will use the Debt Snowball method to build psychological momentum and quick wins.", "💸"))
                    }
...
new_steps = """                    if (relatesToLoans == true) {
...
# Replace loop for i in 0..3 with 0 until steps.size
content = content.replace("for (i in 0..3) {", "for (i in 0 until steps.size) {")
content = content.replace("roadmapStep = 4 // All Done", "roadmapStep = steps.size // All Done")

# Find pages 7..9 block and replace with centered responsive card layout with card-matching button colors and custom generated images
    ...
    new_page_block = """} else if (pageIndex in 7..9) {
                    ...
                    Box(
                        ...
                        Column(
                            ...
                            Box(
                                ...
                                Column(
                                    ...
                                    Text(
                                        ...
                                        fontSize = if (isSmallScreen) 48.sp else 60.sp,
                                        fontWeight = FontWeight.ExtraBold,
                                        lineHeight = 32.sp,
                                        modifier = Modifier
                            ...
                            // Choice Buttons ("No" and "Yes") matching middle card color
                            Row(
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .padding(bottom = 8.dp),
...
"""
    ...
    print("Successfully replaced pages 7..9 block in OnboardingScreen.kt!")
else:
    print(f"ERROR: Start idx={start_idx}, End idx={end_idx}")
